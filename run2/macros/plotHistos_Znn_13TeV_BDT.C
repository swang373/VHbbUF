...
void plotHistos_Znn_13TeV_BDT() {
   ...
   // change this to your channel
    ...
    ev->read(  "MinIf$(abs(deltaPhi(met_phi,Jet_phi)) , Jet_pt>30 && abs(Jet_eta)<4.5 && Jet_puId==1)>1.5"   ,  "MinIf$(abs(deltaPhi(met_phi,Jet_phi)) , Jet_pt>30 && abs(Jet_eta)<4.5 && Jet_puId==1)>1.5", "" , "tree_ZnunuHighPt_ctrl"); 


    weightmc = "efflumi * selectFlags[1]";
    ...
    weightmc = "efflumi * selectFlags[2]";
    ...
    weightmc = "efflumi * selectFlags[3]";
    ...
    weightmc = "efflumi * selectFlags[4]";
    ...
    weightmc = "efflumi * selectFlags[5]";
