...
if isData:
   ...
   usePF2PAT(process,runPF2PAT=True, jetAlgo='AK5', runOnMC=False, postfix=postfix, jetCorrections=inputJetCorrLabel)
else:
...
## redo also the ak5PFJets with pfNoElectrons
...
getattr(process,"patPF2PATSequence"+postfix).replace(
    ...
    getattr(process,"pfNoElectron"+postfix)*process.kt6PFJets*process.ak5PFJets )
