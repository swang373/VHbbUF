...
#"rfio:/castor/cern.ch/user/d/degrutto/2010/ZCands/RECO/EWK_HighPtDiMuonSkim_SD_Mu_139_779_790_4ZCands.root "
...
if isHLT2e32:
#    process.hltFilter.HLTPaths = ["HLT_DoubleMu3_v2"]
    process.hltFilter.HLTPaths = ["HLT_BTagMu_DiJet20U_v1"]     
...
#                                          src     = cms.InputTag( "ak5PFJets" ), # uncorrected input jet collection
#                                          idLevel = cms.string("LOOSE") # Jet Id criteria    )
                                          
#)


#process.jetIDFilter = cms.EDFilter("PFJetCountFilter",
#                                     src = cms.InputTag("PFJetLooseId"),
...
process.cleanPatJets = cms.EDProducer("PATJetCleaner",
                                      ...
                                      preselection = cms.string('pt > 20.0 && abs(eta) < 2.4 && ( (neutralEmEnergy/energy < 0.9) &&  (neutralHadronEnergy/energy < 0.9) && numberOfDaughters>10) '),
...
#                                      finalCut = cms.string('bDiscriminator(\"trackCountingHighEffBJetTags\")>1.7 && bDiscriminator(\"jetProbabilityBJetTags\")>0.988')
                                      finalCut = cms.string('bDiscriminator(\"trackCountingHighEffBJetTags\")>3.3')
