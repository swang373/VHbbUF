    ...
    TH1F * rebin(const TH1F * h, long long nb, const char * newname ="")
    {
        ...
        if (!recreate) {
            ...
            for (int ipart=0; ipart < npartitions; ipart++) {
                ...
                hdummy->Info("Rebin", "Last 10 bins correspond to %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f, %.3f", lowedges.at(iedge-11), lowedges.at(iedge-10), lowedges.at(iedge-9), lowedges.at(iedge-8), lowedges.at(iedge-7), lowedges.at(iedge-6), lowedges.at(iedge-5), lowedges.at(iedge-4), lowedges.at(iedge-3), lowedges.at(iedge-2), lowedges.at(iedge-1));
