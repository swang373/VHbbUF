...
combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_ZnunuHighPt_8TeV.txt >> M1.log
cp mlfit.root mlfit_ZnunuHighPt.root
echo "*** ZnunuMedPt  ***" >! M2.log
combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_ZnunuMedPt_8TeV.txt >> M2.log
cp mlfit.root mlfit_ZnunuMedPt.root
echo "*** ZnunuLowPt  ***" >! M3.log
combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_ZnunuLowPt_8TeV.txt >> M3.log
cp mlfit.root mlfit_ZnunuLowPt.root
#echo "*** ZnunuLowCSV ***" >! M4.log
#combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_ZnunuLowCSV_8TeV.txt >> M4.log
#cp mlfit.root mlfit_ZnunuLowCSV.root
echo "*** combo       ***" >! M5.log
combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_combo_8TeV.txt >> M5.log
cp mlfit.root mlfit_combo.root
echo "*** combo2      ***" >! M6.log
combine -M MaxLikelihoodFit -m 125 --robustFit=1 --stepSize=0.05 --rMin=-5 --rMax=5 --saveNorm vhbb_Znn_J13_bbb_combo2_8TeV.txt >> M6.log
