...
const TString g_dcbbbname   = "vhbb_Znn_J13_bbb_$CHANNEL_8TeV.txt";
const TString g_rootname    = "vhbb_Znn_J13_$CHANNEL_TH1.root";
const TString g_pdfname     = "vhbb_Znn_J13_$CHANNEL_TH1.pdf";
...
const TString g_processes[jmax+1] = {
    "ZH", "WH", "Wj0b", "Wj1b", "Wj2b", "Zj0b", "Zj1b", "Zj2b", "TT", "s_Top", "VVLF", "ZZHF", "WZHF", "QCD"
};
...
/// Main                                                                     ///
////////////////////////////////////////////////////////////////////////////////
void VVBDTShapeWorkspaceJ13(TString strategy="obs", int randomseed=0)  /// strategy: either one of "obs", "blind", "injectsignal", "toy"
{
