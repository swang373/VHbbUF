...
#include "/uscmst1/prod/sw/cms/slc5_amd64_gcc472/lcg/roofit/5.34.03-cms4/include/RooArgList.h"
#include "/uscmst1/prod/sw/cms/slc5_amd64_gcc472/lcg/roofit/5.34.03-cms4/include/RooRealVar.h"
#include "/uscmst1/prod/sw/cms/slc5_amd64_gcc472/lcg/roofit/5.34.03-cms4/include/RooWorkspace.h"
#include "/uscmst1/prod/sw/cms/slc5_amd64_gcc472/lcg/roofit/5.34.03-cms4/include/RooDataHist.h"
...
const TString g_pdfname     = "vhbb_Znn_$CHANNEL_TH1.pdf";
#else
const Int_t jmax            = 10;
const Int_t nsyst           = 13 + 2 * 3;  // plus stat, ZjModel, TTModel
const TString g_realvarname = "CMS_vhbb_BDT_$CHANNEL_8TeV";  // $CHANNEL is replaced in MakeWorkSpace()
...
/// Main                                                                     ///
////////////////////////////////////////////////////////////////////////////////
void BDTShapeWorkspaceJ9(TString strategy="blind")  /// strategy: either one of "real", "blind", "injectsignal"
{
