...
const TString g_pdfname     = "vhbb_Znn_SF_J12_$CHANNEL_TH1.pdf";
...
const int nsyst             = 1 + 2 * 4 + 2 * 5;  // plus WJModel, ZJModel, TTModel, WJSlope, ZJSlope
#else
const int nsyst             = 1 + 2 * 5;  // plus WJModel, ZJModel, TTModel, WJSlope, ZJSlope
#endif
...
/// Main                                                                     ///
////////////////////////////////////////////////////////////////////////////////
void ScaleFactorWorkspaceJ12(TString strategy="real")  /// strategy: either one of "real", "blind", "injectsignal"
{
