...
#ifndef VV_AS_SIGNAL
const int jmax              = 11;
const int nsyst             = 13 + 2 * 6;  // plus stat, WJModel, ZJModel, TTModel, WJSlope, ZJSlope
...
const TString g_pdfname     = "vhbb_Znn_J11_$CHANNEL_TH1.pdf";
#else
const int jmax              = 12;
const int nsyst             = 13 + 2 * 6;  // plus stat, WJModel, ZJModel, TTModel, WJSlope, ZJSlope
const TString g_realvarname = "CMS_vhbb_BDT_$CHANNEL_8TeV";  // $CHANNEL is replaced in MakeWorkSpace()
...
/// Main                                                                     ///
////////////////////////////////////////////////////////////////////////////////
void BDTShapeWorkspaceJ11(TString strategy="blind")  /// strategy: either one of "real", "blind", "injectsignal"
{
