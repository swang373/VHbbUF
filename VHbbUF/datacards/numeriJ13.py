...
macro1 = "VVBDTShapeJ13.C"
macro2 = "VVBDTShapeWorkspaceJ13.C"
#combinecards = "run_combinecards.csh"
#combineasymp = "run_combineasymptoticJ13.csh"
#combineprofi = "run_combineprofilelikelihoodJ13.csh"
#combinemaxli = "run_combinemaxlikelihoodJ13.csh"
combinecards = "run_combinecardsJ13_bbb.csh"
combineasymp = "run_combineasymptoticJ13_bbb.csh"
combineprofi = "run_combineprofilelikelihoodJ13_bbb.csh"
combinemaxli = "run_combinemaxlikelihoodJ13_bbb.csh"
observeasymp = "run_observeasymptoticJ13_bbb.csh"
observeprofi = "run_observeprofilelikelihoodJ13_bbb.csh"
observemaxli = "run_observemaxlikelihoodJ13_bbb.csh"
injectsignal = "run_injectsignalJ13_bbb.csh"

outdir = "res_20130530/"
afsdir = "/afs/cern.ch/user/j/jiafulow/public/vhbb_LHCP_20130530/Znn/"
...
def make(var, analysis, data):
    ...
    #print output[1]
    subprocess.call("cp vhbb_Znn_SI_J13_bbb_Znunu*Pt_8TeV.txt vhbb_Znn_SI_J13_8TeV.root " + outsubdir, shell=True)  # use shell for wildcard expansion
    
    # Default
    p3 = subprocess.Popen(["root", "-b", "-l", "-q", "%s+(%s)" % (newmacro2+".C", "")], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    output = p3.communicate()
    #print output[1]
    subprocess.call("cp vhbb_Znn_J13_bbb_Znunu*Pt_8TeV.txt vhbb_Znn_J13_8TeV.root vhbb_Znn_J13_Znunu*Pt_TH1.* diffNuisances.py " + outsubdir, shell=True)  # use shell for wildcard expansion
...
def numeri(var, analysis, data):
    ...
    # Make copies
    subprocess.call("cp vhbb_Znn_J13_bbb_combo_8TeV.txt vhbb_Znn_J13_combo_8TeV.txt", shell=True)
    subprocess.call("cp vhbb_Znn_SI_J13_bbb_combo_8TeV.txt vhbb_Znn_SI_J13_combo_8TeV.txt", shell=True)
...
def transfer(outdir, afsdir):
    ...
    # make all subdirectories first.
        for subdirname in dirnames:
            ...
            writeme_.append("cp vhbb_Znn_J13_bbb_Znunu*Pt_8TeV.txt vhbb_Znn_J13_bbb_combo_8TeV.txt vhbb_Znn_J13_8TeV.root vhbb_Znn_J13_Znunu*Pt_TH1.* vhbb_Znn_J13_combo_8TeV.txt asymp.log profi.log maxli.log nuisances*.html " + path2)
            writeme_.append("cp vhbb_Znn_SI_J13_* " + path2)
            writeme_.append("cd -")
    writeme = "\n".join(writeme_)
